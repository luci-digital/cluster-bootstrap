...
case $MY_IP in
    192.168.1.146) hostnamectl set-hostname storage-1.lucidigital.net ;;
    192.168.1.147) hostnamectl set-hostname storage-2.lucidigital.net ;;
...
case $MY_IP in
    192.168.1.146) MY_IPV6="2602:F674:0001:0146::1/64" ;;
    192.168.1.147) MY_IPV6="2602:F674:0001:0147::1/64" ;;
    *) MY_IPV6="" ;;
esac
...
/tmp/thread-to-lucia.sh storage
%end
